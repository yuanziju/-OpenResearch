...
/// Mirrors `jdk.graal.compiler.util.args.InvalidArgumentException`.
#[derive(Debug)]
...
impl InvalidArgumentException {
    pub(crate) fn new(name: &str, reason: &str) -> Self {
        InvalidArgumentException {
            message: format!("The argument '{}' could not be parsed: {}", name, reason),
        }
    }
}
