...
//
// Rust mirror of `jdk.graal.compiler.util.args.DoubleValue`.
...
/// Mirrors `jdk.graal.compiler.util.args.DoubleValue`.
...
impl DoubleValue {
    ...
    pub fn new_with_default(name: String, default_value: f64, help: String) -> Self {
        DoubleValue {
            value: None,
...
impl AnyOptionValue for DoubleValue {
