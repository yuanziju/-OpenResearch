...
//
// Rust mirror of `jdk.graal.compiler.phases.common.DeadCodeEliminationPhase`.
...
/// Dead code elimination phase — removes unused code.
/// Mirrors `jdk.graal.compiler.phases.common.DeadCodeEliminationPhase`.
#[derive(Debug, Clone, Copy)]
pub struct DeadCodeEliminationPhase;

impl DeadCodeEliminationPhase {
    /// Singleton instance.
    pub const SINGLETON: Self = Self;
}

impl<C> BasePhase<C> for DeadCodeEliminationPhase {
    ...
    fn get_name(&self) -> String {
        "DeadCodeEliminationPhase".to_string()
    }
}