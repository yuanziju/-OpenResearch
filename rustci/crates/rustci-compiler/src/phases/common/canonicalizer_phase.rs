...
//
// Rust mirror of `jdk.graal.compiler.phases.common.CanonicalizerPhase`.
...
/// Canonicalizer phase — performs constant folding, strength reduction,
/// and algebraic simplifications.
/// Mirrors `jdk.graal.compiler.phases.common.CanonicalizerPhase`.
#[derive(Debug, Clone, Copy)]
pub struct CanonicalizerPhase;

impl CanonicalizerPhase {
    /// Singleton instance.
    pub const SINGLETON: Self = Self;
}

impl<C> BasePhase<C> for CanonicalizerPhase {
